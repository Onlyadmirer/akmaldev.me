...
function MobileNav() {
  ...
  return (
    <div
      className={`py-4 flex flex-col px-4 fixed inset-x-0 top-0 z-50 bg-transparent dark:bg-black/40 border-b border-primary/20 w-full backdrop-blur-3xl ${
